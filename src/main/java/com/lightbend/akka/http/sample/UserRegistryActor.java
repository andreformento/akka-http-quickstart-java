    ...
    public Receive createReceive() {
        return receiveBuilder()
                ...
                .match(CreateUser.class, createUser -> {
                    ...
                    getSender().tell(
                            new UserRegistryMessages.ActionPerformed(String.format("User %s created.", createUser.getUser().getName())),
                            getSelf()
                    );
                })
                ...
                .match(UserRegistryMessages.DeleteUser.class, deleteUser -> {
                    ...
                    getSender().tell(
                            new UserRegistryMessages.ActionPerformed(String.format("User %s deleted.", deleteUser.getName())),
                            getSelf()
                    );
